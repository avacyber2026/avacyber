...
export default function GuidePage() {
  ...
  const cardClass =
    "block rounded-xl p-5 border border-gray-200 dark:border-white/15 bg-white dark:bg-[#232522] transition-shadow hover:shadow-md dark:hover:shadow-[0_4px_20px_-4px_rgba(0,0,0,0.25)]";

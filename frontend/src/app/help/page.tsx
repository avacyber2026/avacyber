    ...
    <>
      ...
      <VStack className="w-full min-h-screen items-stretch">
        <Box className={`${style.main} bg-[#F4F3F4] dark:bg-[#131C18] p-6`} as={motion.div} initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
          ...
          <Box className="p-6 rounded-lg bg-white dark:bg-[#1B2620] border border-gray-200 dark:border-white/20 mb-6 max-w-[700px]">
          ...
          <Box className="p-6 rounded-lg bg-white dark:bg-[#1B2620] border border-gray-200 dark:border-white/20 max-w-[700px]">

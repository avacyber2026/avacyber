          ...
          <Box className="relative px-4 pb-12 pt-4 md:px-6 lg:px-8 max-w-[1600px] mx-auto w-full">
                ...
                <div className="grid gap-4">
                  {[
                    ...
                    <div key={m.label}>
                      ...
                      <div className="h-3 rounded-full bg-slate-200/80 dark:bg-[#2c2f2c] overflow-hidden">
                        <div
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              >
                ...
                <div className="p-4 border-t border-white/40 dark:border-[#2c2f2c]">
                  <button
                    type="button"
                  ...
                  {expandedProfile && (
                    <div className="space-y-1 pt-1">
                      <Link
                        href="/tickets"
                        className="flex items-center gap-3 rounded-lg px-3 py-2.5 hover:bg-white/60 dark:hover:bg-[#2c2f2c] transition-colors text-slate-700 dark:text-slate-200"
                      >
                      ...
                      <Tooltip
                        ...
                        content={({ active, payload, label }) =>
                          active && payload?.length ? (
                            <div
                              className={`rounded-lg px-3 py-2 border ${isDark ? "bg-[#232522] border-[#2c2f2c] shadow-[0_4px_20px_-4px_rgba(0,0,0,0.25)]" : "bg-white border-slate-200 shadow-xl"}`}
                            >
              ...
              >
                      ...
                      <PieChart>
                        ...
                        >
                          {statusData.map((entry, index) => (
                            <Cell key={`c-${index}`} fill={entry.color} stroke={isDark ? "#232522" : "#fff"} strokeWidth={2} />
                          ))}
                        </Pie>
                        <Tooltip
                          contentStyle={{
                            background: isDark ? "#232522" : "#fff",
                            border: `1px solid ${isDark ? "#2c2f2c" : "#e2e8f0"}`,
                            borderRadius: "8px",
                          }}
                        />
                ...
                <div className={`rounded-lg p-5 ${dash.glass}`}>
                  ...
                  <div className="flex h-4 rounded-full overflow-hidden shadow-inner bg-slate-200/50 dark:bg-[#2c2f2c]">
                    {pipeline.map((seg) => (
                      <div
                        key={seg.key}
                        title={seg.label}
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="px-3 py-1 rounded-full bg-white/70 dark:bg-[#2c2f2c] text-sm font-medium text-slate-700 dark:text-slate-200 border border-white/80 dark:border-[#2c2f2c]"
                    >
                      ←
                    </button>
                      ...
                      <div
                        ...
                        className={`text-center rounded-lg py-3 px-1 border transition-all ${
                          isToday
                            ...
                            : "bg-white/50 dark:bg-[#2c2f2c]/55 border-white/60 dark:border-[#2c2f2c] text-slate-700 dark:text-slate-200"
                        }`}
                      >
                    ...
                    weekEvents.slice(0, 12).map((ev) => (
                      <Link
                        ...
                        className={`flex items-center gap-3 rounded-lg px-4 py-3 border transition-all hover:shadow-md dark:hover:shadow-[0_2px_12px_-2px_rgba(0,0,0,0.22)] ${
                          ev.resolved
                            ? "bg-slate-100/80 dark:bg-[#2c2f2c]/70 border-slate-200/80 dark:border-[#2c2f2c]"
                  ...
                  {recentItems.length === 0 ? (
                    ...
                    recentItems.map((row) => (
                      <Link
                        key={row.id}
                        href={row.href}
                        className="flex items-center gap-3 rounded-lg px-3 py-3 border border-white/50 dark:border-[#2c2f2c] bg-white/40 dark:bg-[#2c2f2c]/40 hover:bg-white/70 dark:hover:bg-[#2c2f2c] transition-colors"
                      >

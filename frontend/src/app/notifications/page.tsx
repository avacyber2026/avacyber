            ...
            <>
              ...
              <VStack align="stretch" spacing={3}>
                {list.length === 0 ? (
                  ...
                  list.map((n) => (
                    <Box key={n.id} className={`p-4 rounded-lg bg-white dark:bg-[#232522] border border-gray-200 dark:border-white/20 ${n.readAt ? "opacity-85" : ""}`}>
                        ...
                        <div className="mt-2 flex flex-wrap gap-3">
                          {n.ticketId != null && Number.isFinite(Number(n.ticketId)) ? (
                            <Link
                              ...
                              className="text-sm font-medium text-[#1F6A5C] dark:text-[#50BFA0] hover:underline"
                            >

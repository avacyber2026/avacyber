...
export function IncidentLogCard({
  ...
  return (
    <motion.article
      ...
      className="w-full rounded-xl border border-[#1F6A5C]/20 dark:border-white/15 bg-white dark:bg-[#1E2128] shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden"
    >

  ...
  return (
    <div className={style.reportPremium}>
      {status === "Security Manager" && (
        <Box className="mb-4 p-4 bg-white dark:bg-[#103E36] rounded-lg border border-[#1F6A5C]/20 dark:border-white/20">
      ...
      {viewMode === "table" ? (
        <TableContainer className="bg-white dark:bg-[#103E36] rounded-lg border border-[#1F6A5C]/20 dark:border-white/20 overflow-x-auto">
          <Table>
            <Thead>
              <Tr>
                    ...
                    {!x.status && status !== "" && CREATOR_ROLES.includes(status as UserStatus) && (
                      <VStack align="stretch" spacing={2} className="min-w-[200px]">
                        <Textarea
                          ...
                          rows={2}
                          className="text-sm border border-[#1F6A5C]/20 dark:border-white/20 rounded focus:ring-2 focus:ring-brand-primary bg-white dark:bg-[#103E36] text-[#103E36] dark:text-white resize-y"
                        />
              ...
              {status !== "" && CREATOR_ROLES.includes(status as UserStatus) && (
                <VStack align="stretch" spacing={3} style={{ marginTop: 16 }} className="pt-4 border-t border-[#1F6A5C]/20 dark:border-white/20">
                  ...
                  <Textarea
                    ...
                    onChange={(e) => setResolveComments((prev) => ({ ...prev, [x.id]: e.target.value }))}
                    rows={3}
                    className="w-full text-sm border border-[#1F6A5C]/20 dark:border-white/20 rounded-lg focus:ring-2 focus:ring-brand-primary bg-white dark:bg-[#103E36] text-[#103E36] dark:text-white resize-y p-3"
                  />
                  <Button
                    as={motion.button}

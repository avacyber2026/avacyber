      ...
      <TabPanels>
        ...
        {showStatsTab && (
          <TabPanel index={2}>
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.1 }}>
            <Box className="py-4">
              <Box className="mb-6 p-4 bg-white dark:bg-[#232522] rounded-lg border border-gray-200 dark:border-white/20">
              ...
              <SimpleGrid columns={4} spacing={4} className="mb-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
                {(["User", "GRC", "IAM", "Pentesting"] as const).map((label, i) => (
                  ...
                  >
                    <Box
                      className="p-4 bg-white dark:bg-[#232522] rounded-lg border border-gray-200 dark:border-white/20 shadow-sm hover:shadow-md"
                    >
              ...
              <Box className="p-4 bg-white dark:bg-[#232522] rounded-lg border border-gray-200 dark:border-white/20">
